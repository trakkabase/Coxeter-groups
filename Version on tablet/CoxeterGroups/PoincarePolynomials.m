...
(* :Title: PoincarePolynomials *) 
(* :Author: David Sheard *)
(* :Summary: Functions to compute and study the Poicare polynomials of elements of a Coxeter system. *)
(* :Context: CoxeterGroups`PoincarePolynomials` *)
(* :Package version: 1.0 *)
